		...
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							...
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" pattern="[A-Za-z '-]{5,10}" title="5 ou 10 caractères" placeholder="Nom Etudiant , Prenom Etudiant , Matricule Etudiant" onkeyup='load(1);'>
							</div>
							<div class="col-md-3">
